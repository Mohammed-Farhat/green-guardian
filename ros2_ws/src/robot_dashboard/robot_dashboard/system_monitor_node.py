...
Publishes CPU temperature, CPU usage, RAM usage, fan speed, and power
throttle status at 1 Hz.
...
Topics published:
  ...
  /system/throttled   (std_msgs/Int32)   — vcgencmd get_throttled value
                                           0x0=OK, 0x1=under-voltage now,
                                           0x10000=UV occurred; -1=unreadable
"""
...
class SystemMonitorNode(Node):
    ...
    def __init__(self):
        ...
        self.pub_throttled = self.create_publisher(Int32,   '/system/throttled', 10)
    ...
    def publish_all(self):
        ...
        self.pub_throttled.publish(Int32(data=self._throttled()))
    ...
    def _throttled(self) -> int:
        """Read vcgencmd get_throttled. Returns raw int (0=OK) or -1 on error."""
        try:
